    ...
    @if(!Str::contains(url()->current(),['viec-da-luu','viec-ung-tuyen','cv','tai-khoan','tim-kiem']))
        <div class="footer">
            <div class="footer__wrap container-fluid py-4">
                <p class="footer-text">Copyright Thai Nguyen Jobs</p>
                <div class="footer__social">
                    <a
                        href="https://www.facebook.com/zzimmzimmz.khanhs.26"
                        class="footer__social-link"
                        target="_blank"
                    >
                        <i class="fa-brands fa-facebook"></i>
                    </a>
                    <a href="https://github.com/NamKhanh00" class="footer__social-link">
                        <i class="fa-brands fa-github"></i>
                    </a>
                    <a
                        href="namkhanh2003sn@gmail.com"
                        class="footer__social-link"
                    >
